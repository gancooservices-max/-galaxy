...
code = code.replaceAll("this.scene.add(points);", "this.skyGroup.add(points);");
code = code.replaceAll("this.scene.add(new THREE.Points(dustGeo, dustMat));", "this.skyGroup.add(new THREE.Points(dustGeo, dustMat));");
code = code.replaceAll("this.scene.add(mesh);", "this.skyGroup.add(mesh);");
code = code.replaceAll("this.scene.add(this.pointsMesh);", "this.skyGroup.add(this.pointsMesh);");
...
const match = code.match(/  _createSun\(\) \{[\s\S]*?(?=  flyToEarth\(\))/);
if (match) {
    const replacement = `  _createEarth() {
